...
[![Deploy](https://www.herokucdn.com/deploy/button.svg)](https://t.me/LupiiDinHaita)

## Deploy to Railway
<p><a href=https://github.com/Smashulica/LupiiVideoPlayer/issues/7> <img src="https://img.shields.io/badge/Deploy%20To%20Railway-blueviolet?style=for-the-badge&logo=railway" width="200""/></a></p>

 
## Deploy to VPS

```sh
git clone https://github.com/Smashulica/LupiiDinHaita
cd LupiiDinHaita
